# USAGE
# python opencv-ar.py --image examples/input_01.jpg --source sources/squirrel.jpg
...
# resize image to 600w
image = imutils.resize(image, width=600)
# grab spatial dimensions for reference
...
# destination matrix where we put together the coordinates
...
# 3 channel source RGB image, applied to a mask that needs 3 channels
